...
const usernameReceiver = document.getElementById('receiver_id').value;
...
message.addEventListener('keypress', () => {
    ...
    socket.emit('typing-message', {
        handle: handle.value,
        intendedReceiver: usernameReceiver
    });
});
...
socket.on('chat-message', (data) => {
    ...
    if(handle.value == data.intendedReceiver || handle.value == data.handle){
...
socket.on('typing-message', (data) => {
    if(handle.value == data.intendedReceiver){
